              ...
              >
                ...
                <h2 className="mt-4 text-3xl md:text-4xl font-serif font-bold text-uk-blue mb-6">
                  <span className="relative inline-block">
                    <span className="relative z-10">Premium Quality Certification</span>
                    <span className="absolute bottom-1 left-0 w-full h-2 bg-gold/20 transform -skew-x-6"></span>
                  </span>
                </h2>
                
                <p className="mb-6 text-gray-700 leading-relaxed">
                  Each Greenwich certificate is meticulously designed to reflect the prestige and quality of your educational achievement, featuring premium materials and advanced security features.
              </p>
                ...
                >
                  <a 
                    href="/courses" 
                    className="relative overflow-hidden group px-8 py-4 bg-gradient-to-r from-uk-blue to-blue-600 text-white rounded-lg shadow-lg hover:shadow-blue-200/50 transition-all duration-300 inline-flex items-center font-medium"
                  >
                    <span className="relative z-10">View Our Courses</span>
                    <span className="group-hover:translate-x-1 transition-transform duration-300 relative z-10 ml-2">
                      <FaChevronRight />
                    </span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-gold scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span>
                    <span className="absolute inset-0 bg-gradient-to-r from-gold/0 via-gold/30 to-gold/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 group-hover:translate-x-full"></span>
                  </a>
                  
                  <a 
                    href="#verify-certificate" 
                    className="relative overflow-hidden group px-8 py-4 bg-white border border-uk-blue/20 text-uk-blue rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 inline-flex items-center font-medium"
                  >
                    <span className="relative z-10">Verify Certificate</span>
                    <span className="group-hover:translate-x-1 transition-transform duration-300 relative z-10 ml-2">
                      <FaSearch />
                    </span>
                    <span className="absolute inset-0 bg-gradient-to-r from-gold/0 via-gold/10 to-gold/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
                  </a>
                </motion.div>
              </motion.div>
            </div>
