const arTranslations = {
  ...
  'courses_hero_highlight': 'دوراتنا',
  ...
  'testimonials_hero_title': 'شهادات',
  ...
  'testimonials_video_title': 'اسمع من خريجينا',
  ...
  'partnerships_main_description': 'تتعاون هذه المنظمات الرئيسية مع معهد غرينيتش لتعزيز عروضنا التعليمية، وتقوية وجودنا العالمي، وخلق فرص قيمة لطلابنا وأعضاء هيئة التدريس.',
